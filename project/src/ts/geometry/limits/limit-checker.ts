...
abstract class LimitChecker {
     ...
     */
    ifInLimits(position: Point3D, block: (position: Point3D) => void): LimitChecker {
     ...
     * @return this limit checker
     */
    ifOutOfLimits(position: Point3D, block: (position: Point3D) => void): LimitChecker {
     ...
     * @return `this` object
     */
    apply(block: (limitChecker: LimitChecker) => void): LimitChecker {
        block(this)
        return this
    }
     ...
     */
    map<R>(block: (limitChecked: LimitChecker) => R): R {
        return block(this)
    }
