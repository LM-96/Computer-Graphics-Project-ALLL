...
class MatrixAlgebra {
    static add(mat1, mat2OrScalar) {
        ...
        if (typeof mat2OrScalar == "number") {
            ...
            res = (0, matrix_factory_1.matrix)(mat1.rowSize(), mat1.columnSize());
    ...
    static multiply(mat1, mat2OrScalar) {
        ...
        if (typeof mat2OrScalar == "number") {
            ...
            res = (0, matrix_factory_1.matrix)(mat1.rowSize(), mat2.columnSize(), 0);
    ...
    static transpose(mat) {
        let res = (0, matrix_factory_1.matrix)(mat.columnSize(), mat.rowSize());
    ...
    static minor(mat, row, column) {
        let res = (0, matrix_factory_1.matrixData)(mat.rowSize() - 1, mat.columnSize() - 1);
        let rR = 0;
        let cR = 0;
        for (let r = 0; r < mat.rowSize(); r++) {
            if (r != row) {
        ...
        return (0, matrix_factory_1.matrix)(res);
    }
    /**
    ...
    static cofactorMatrix(mat) {
        let res = (0, matrix_factory_1.matrix)(mat.rowSize(), mat.columnSize());
        for (let r = 0; r < mat.rowSize(); r++) {
            for (let c = 0; c < mat.columnSize(); c++) {
    ...
    static characteristicPolynomial(mat) {
        ...
        return function (lambda) {
            return MatrixAlgebra.determinant(MatrixAlgebra.subtract(mat, MatrixAlgebra.multiply((0, matrix_factory_1.identityMatrix)(mat.rowSize()), lambda)));
        };
    }
}
