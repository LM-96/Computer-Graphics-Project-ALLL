...
class FrozenRowBasedMatrix extends abstract_matrix_1.AbstractMatrix {
    constructor(data) {
        ...
        if (data.length > 0) {
            (0, matrix_factory_1.checkValidMatrixData)(data, true);
...
FrozenRowBasedMatrix.factory = new class extends matrix_factory_1.MatrixFactory {
    createMatrix(rows, columns, fill) {
        if (typeof rows == "number") {
            return new FrozenRowBasedMatrix((0, matrix_factory_1.matrixData)(rows, columns, fill));
        }
        else {
