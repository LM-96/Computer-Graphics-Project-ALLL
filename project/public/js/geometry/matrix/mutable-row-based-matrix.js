...
class MutableRowBasedMatrix extends abstract_matrix_1.AbstractMatrix {
    ...
    multiply(other) {
        ...
        if (typeof other == "number") {
            ...
            let data = (0, matrix_factory_1.matrixData)(__classPrivateFieldGet(this, _MutableRowBasedMatrix_totRows, "f"), __classPrivateFieldGet(this, _MutableRowBasedMatrix_totColumns, "f"));
...
MutableRowBasedMatrix.factory = new class extends matrix_factory_1.MatrixFactory {
