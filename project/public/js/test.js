...
let matrix = matrix_1.Matrix.asMatrix([[1, 0, 0], [0, 1, 0], [0, 0, 1]]);
console.log("is diagonal: " + matrix.isDiagonal());
let matrix2 = matrix_1.Matrix.asMatrix([[1, 1, 1], [0, 1, 1], [0, 0, 1]]);
console.log("is upper triangular: " + matrix2.isUpperTriangular());
console.log("is triangular: " + matrix2.isTriangular());
let matrix3 = matrix_1.Matrix.asMatrix([[1, 0, 0], [1, 1, 0], [1, 1, 1]]);
