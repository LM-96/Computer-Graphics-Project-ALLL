...
class ArraySingleSignalFlow {
    ...
    subscribe(options) {
        let res = new subscriptions_1.SubscriptionReceipt(this.signalName.name + "#" + __classPrivateFieldGet(this, _ArraySingleSignalFlow_id, "f").toString(), this.signalName, subscriptions_1.SubscriptionStatus.ACCEPTED);
    ...
    unsubscribe(subscriptionReceipt) {
        if (__classPrivateFieldGet(this, _ArraySingleSignalFlow_subscriptions, "f").delete(subscriptionReceipt.subscriptionId)) {
